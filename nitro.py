...
# Ссылка на исходник и .exe файл в описании

# P.S. Это нерабочее, поскольку тут обычный рандом, настоящие генераторы караются баном аккаунт дискорд! Данный "Генератор" обычный розыгрыш, можете давать друзьям чисто по фану, если они у вас, конечно, не прошаренные в этой теме.
